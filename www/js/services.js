...
angular.module('guesser.services', ['ngResource'])
    ...
    .factory('commentFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
        ...
        return $resource(baseURL + "guess/:id/comments/:commentId", { id: "@Id", commentId: "@CommentId" }, {
            'update': {
                method: 'PUT'
            }
        });
